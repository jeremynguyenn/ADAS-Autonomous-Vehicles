...
uint8_t Right_Blind_Distance = 0;
uint8_t Left_Blind_Distance = 0;
...
uint8_t RxAddess[] = {0x00,0xDD,0xCC,0xBB,0xAA};
uint8_t TxAddess[] = {0xEE,0xDD,0xCC,0xBB,0xAA};
uint8_t Accident[] = "Accident" ;
uint8_t Blind[] = "Blind" ;

uint8_t RxData[32];

volatile int object1detected = 0;
/* USER CODE END PTD */
